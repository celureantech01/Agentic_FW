...
res_simple = chain.invoke(
    {
        "question": "tell me which data points you need to predict TESLA stock in next few days with probability of more than 70%. give me your response ina short form with just a few sentences ",
    }
)
